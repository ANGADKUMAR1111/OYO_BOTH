...
public class RedisConfig {
    ...
    public RedisCacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        // Setup Object Mapper to retain type metadata, which is critical for deserializing Generic PageImpl and List objects properly
        ...
        RedisCacheConfiguration defaultCacheConfig = RedisCacheConfiguration.defaultCacheConfig()
                .entryTtl(Duration.ofMinutes(15)) // Moderate TTL for frequently stale data
